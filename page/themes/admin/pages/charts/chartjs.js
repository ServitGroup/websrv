export default {
    ...
    mounted() {
        ...
        var pieOptions = {
            ...
            percentageInnerCutout: 50, //Number - Amount of animation steps // This is 0 for Pie charts
            ...
            maintainAspectRatio: true, //String - A legend template
        ...
        var barChartOptions = {
            ...
            legendTemplate: '<ul class="<%=name.toLowerCase()%>-legend"><% for (var i=0; i<datasets.length; i++){%><li><span style="background-color:<%=datasets[i].fillColor%>"></span><%if(datasets[i].label){%><%=datasets[i].label%><%}%></li><%}%></ul>', //Boolean - whether to make the chart responsive
            responsive: true,
