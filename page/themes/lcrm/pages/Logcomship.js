                                    ...
                                    <div class="col-sm-12">
                                        <div id="data_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                                                                <select v-model="selectprovider"  class="form-control input-sm">
                                                                    <option value="-1">All</option>
                                                                    <option v-for="provider in providers" :value="provider.providers_name">{{provider.providers_name}}</option>
                                                                </select>
                                                </div>
                                                <div class="col-sm-6">
...
`,
    ...
    computed: {
        filteredData() {
            ...
            if (this.selectprovider != -1) {
                data = data.filter(r => r.providers_name == this.selectprovider);
            }
            if (filtertxt) {
